...
### 2. Raspberry Pi (Main Server, Database) * 추후 코드 수정
 ...
 1. MariaDB & PhpMyAdmin
    ...
    <img src = "https://github.com/subin111/Quitsmoking_management-system/assets/143717650/45d5d339-dac3-404b-a612-6c0eb538302a" width = "500" height = "200"/>
...
## 5. 결론
   ...
   * 문제점 및 개선점
     ...
     3. 센터에서 디바이스로의 데이터 전송을 추가 => 금연 센터에서 사용자들을 적극적으로 관리할 수 있도록 함
           ex) LSB님 흡연 횟수를 줄이셔야 합니다.   ex) 목표 달성 마감일까지 9일 남았습니다.
